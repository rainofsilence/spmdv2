...
public class CodeGenerator {
     ...
     * 数据库连接url
     */
    private static final String DB_URL = "jdbc:mysql://localhost:3306/spmd?serverTimezone=GMT%2B8&characterEncoding=utf-8";
     ...
     */
    private static final String PACKAGE_NAME = "cn.silence.dao";

    /**
     * 项目根路径
     */
    private static final String BASE_PATH = System.getProperty("user.dir") + "\\spmdv2-dao\\src\\main\\java\\";
